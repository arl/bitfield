...
func run(cfg *config) error {
	...
	var g generator
	g.printf("package %s\n\n", cfg.pkgname)
	g.printf("// Code generated by bitfield %s. DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
...
func (g *generator) format(out string) error {
	buf, err := format.Source(g.buf.Bytes())
	if err != nil {
		return fmt.Errorf("go format failed: %s", err)
	}
	if err := os.WriteFile(out, buf, 0666); err != nil {
